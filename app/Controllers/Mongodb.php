...
Class Mongo_db{
	...
	*/
	...
	function __construct($param)
	{
		...
		$config['mongo_db']['no_auth'] = true;
		$config['mongo_db']['hostname'] = 'localhost';
		$config['mongo_db']['port'] = '27017';
		$config['mongo_db']['username'] = '';
		$config['mongo_db']['password'] = '';
		$config['mongo_db']['database'] = 'test';
		...
		$config['mongo_db']['read_preference'] = 'primary'; 
		$config['mongo_db']['read_concern'] = 'local'; //'local', 'majority' or 'linearizable'
		$config['mongo_db']['legacy_support'] = TRUE;
